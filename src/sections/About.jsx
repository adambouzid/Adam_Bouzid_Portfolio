...
const About = () => {
  ...
  return  <section className="c-space section-spacinp">
    <h2 className="text-hidden">About Me</h2>
    <div className="grid grid-cols-1  gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
      ...
      <div className="flex items-end grid-default-color grid-1">
        ...
        <div className="z-10">
            <p className="headtext">Hi, I'm Adam Bouzid</p>
            <p className="subtext">Passionate developer with a strong background in web development. Let's connect and explore the world of technology together!</p>
        </div>  
      ...
      <div className="grid-default-color grid-2">
       <div ref={grid2container} className="flex items-center justify-center w-full h-full">
        ...
        <Card style={{ rotate: "-45deg" , top: "70%" , left: "25%" }} image="assets/logos/blazor-pink.png" containerRef={grid2container}/>
       </div>
      </div>
      ...
      <div className="grid-black-color grid-3">
        <div className="z-10 w-[50%]">
            ...
            <p className="subtext">I'm in Morocco, and open to Work</p>
        </div>
      ...
      <div className="flex flex-col items-center justify-center gap-4 size-full">
        <p className="text-center headText">You want to start a project together?</p>
        <CopyEmailButton/>
      </div>
      </div>
